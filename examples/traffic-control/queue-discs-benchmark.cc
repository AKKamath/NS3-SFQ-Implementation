...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("queueDiscType", "Bottleneck queue disc type in {PfifoFast, ARED, CoDel, FqCoDel, PIE, prio, SFQ}", queueDiscType);
  ...
  if (queueDiscType.compare ("PfifoFast") == 0)
    ...
    {
      tchBottleneck.SetRootQueueDisc ("ns3::SfqQueueDisc");
      Config::SetDefault ("ns3::SfqQueueDisc::MaxSize", QueueSizeValue (QueueSize (QueueSizeUnit::PACKETS, queueDiscSize)));
    }
  else
    {
