...
main (int argc, char *argv[])
{
  ...
  if (writeForPlot)
    {
      filePlotQueueDisc << pathOut << "/" << "sfq-queue-disc.plotme";
      filePlotQueueDiscAvg << pathOut << "/" << "sfq-queue-disc_avg.plotme";
